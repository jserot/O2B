...
let list_sum_and_length l = List.fold_left (fun (acc,cnt) x -> (acc+x, cnt+1)) (0,0) l  (* OCaml implementation *)
...
let print_result (r1,r2) = 
  Serial.write_string "length=";
  Serial.write_int r2;
  Serial.write_string " sum=";
  Serial.write_int r1;
  Serial.write_string "\n"
...
let test l = 
    let r1, t1 = chrono list_sum_and_length l in
    print_result r1;
