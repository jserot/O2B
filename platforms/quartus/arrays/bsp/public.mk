...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../qsys/nios_128k_extended.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_128k_extended
SOPC_NAME := nios_128k_extended
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x210f0
SOPC_SYSID_FLAG += --sidp=0x210f0
ELF_PATCH_FLAG  += --sidp 0x210f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1625733768
SOPC_SYSID_FLAG += --timestamp=1625733768
ELF_PATCH_FLAG  += --timestamp 1625733768
