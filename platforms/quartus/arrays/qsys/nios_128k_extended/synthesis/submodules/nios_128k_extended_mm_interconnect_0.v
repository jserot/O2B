...
module nios_128k_extended_mm_interconnect_0 (
	...
	wire   [14:0] rsp_mux_002_src_channel;                                                   // rsp_mux_002:src_channel -> STAB_CC_0_rm_agent:rp_channel
	...
	wire   [14:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> sys_id_control_slave_agent:cp_channel
	...
	wire   [14:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> STAB_CC_0_s0_agent:cp_channel
	...
	wire  [109:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [109:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // button_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [14:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> button_s1_agent:cp_channel
	...
	wire  [109:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> hex0_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                     // hex0_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [14:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex0_s1_agent:cp_channel
	...
	wire  [109:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> hex1_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // hex1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [14:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> hex1_s1_agent:cp_channel
	...
	wire  [109:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> hex2_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                     // hex2_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [14:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex2_s1_agent:cp_channel
	...
	wire  [109:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> hex3_s1_agent:cp_data
	...
	wire  [109:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> hex4_s1_agent:cp_data
	...
	wire  [109:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> hex5_s1_agent:cp_data
	...
	wire  [109:0] sys_id_control_slave_agent_rp_data;                                        // sys_id_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [109:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire          stab_cc_0_s0_agent_rp_valid;                                               // STAB_CC_0_s0_agent:rp_valid -> router_006:sink_valid
	wire  [109:0] stab_cc_0_s0_agent_rp_data;                                                // STAB_CC_0_s0_agent:rp_data -> router_006:sink_data
	wire          stab_cc_0_s0_agent_rp_ready;                                               // router_006:sink_ready -> STAB_CC_0_s0_agent:rp_ready
	wire          stab_cc_0_s0_agent_rp_startofpacket;                                       // STAB_CC_0_s0_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          stab_cc_0_s0_agent_rp_endofpacket;                                         // STAB_CC_0_s0_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [109:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [109:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [109:0] switch_s1_agent_rp_data;                                                   // switch_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [109:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [109:0] hex0_s1_agent_rp_data;                                                     // hex0_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [109:0] hex1_s1_agent_rp_data;                                                     // hex1_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [109:0] hex2_s1_agent_rp_data;                                                     // hex2_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [109:0] hex3_s1_agent_rp_data;                                                     // hex3_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [109:0] hex4_s1_agent_rp_data;                                                     // hex4_s1_agent:rp_data -> router_015:sink_data
	...
	wire  [109:0] hex5_s1_agent_rp_data;                                                     // hex5_s1_agent:rp_data -> router_016:sink_data
	...
	wire   [14:0] cmd_demux_002_src0_channel;                                                // cmd_demux_002:src0_channel -> cmd_mux_004:sink2_channel
	...
	wire   [14:0] rsp_demux_004_src2_channel;                                                // rsp_demux_004:src2_channel -> rsp_mux_002:sink0_channel
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_003 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_004 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_006 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_008 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_009 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_010 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_011 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_012 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_013 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_014 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_015 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_016 (
	...
	nios_128k_extended_mm_interconnect_0_router_003 router_017 (
	...
	nios_128k_extended_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_extended_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_extended_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_extended_mm_interconnect_0_cmd_demux_002 rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
