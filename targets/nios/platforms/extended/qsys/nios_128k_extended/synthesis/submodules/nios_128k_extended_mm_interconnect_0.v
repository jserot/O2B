...
module nios_128k_extended_mm_interconnect_0 (
	...
	wire  [96:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> button_s1_agent:cp_data
	...
	wire  [96:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> timer_s1_agent:cp_data
	...
	wire  [96:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [96:0] timer_s1_agent_rp_data;                                                    // timer_s1_agent:rp_data -> router_015:sink_data
	...
	nios_128k_extended_mm_interconnect_0_router_004 router_005 (
	...
	nios_128k_extended_mm_interconnect_0_router_002 router_006 (
	...
	nios_128k_extended_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_extended_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_extended_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
