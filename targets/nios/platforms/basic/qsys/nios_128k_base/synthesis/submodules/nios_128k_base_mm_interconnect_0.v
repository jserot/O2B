...
module nios_128k_base_mm_interconnect_0 (
	...
	wire  [12:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> button_s1_agent:cp_channel
	...
	wire         cmd_mux_012_src_valid;                                                     // cmd_mux_012:src_valid -> sys_timer_s1_agent:cp_valid
	wire  [95:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> sys_timer_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                     // sys_timer_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [12:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> sys_timer_s1_agent:cp_channel
	wire         cmd_mux_012_src_startofpacket;                                             // cmd_mux_012:src_startofpacket -> sys_timer_s1_agent:cp_startofpacket
	wire         cmd_mux_012_src_endofpacket;                                               // cmd_mux_012:src_endofpacket -> sys_timer_s1_agent:cp_endofpacket
	...
	wire         sys_timer_s1_agent_rp_valid;                                               // sys_timer_s1_agent:rp_valid -> router_014:sink_valid
	wire  [95:0] sys_timer_s1_agent_rp_data;                                                // sys_timer_s1_agent:rp_data -> router_014:sink_data
	wire         sys_timer_s1_agent_rp_ready;                                               // router_014:sink_ready -> sys_timer_s1_agent:rp_ready
	wire         sys_timer_s1_agent_rp_startofpacket;                                       // sys_timer_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire         sys_timer_s1_agent_rp_endofpacket;                                         // sys_timer_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire         sys_timer_s1_agent_rdata_fifo_src_valid;                                   // sys_timer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire  [33:0] sys_timer_s1_agent_rdata_fifo_src_data;                                    // sys_timer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire         sys_timer_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_012:in_0_ready -> sys_timer_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_012_out_0_valid;                                         // avalon_st_adapter_012:out_0_valid -> sys_timer_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_012_out_0_data;                                          // avalon_st_adapter_012:out_0_data -> sys_timer_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_012_out_0_ready;                                         // sys_timer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire   [0:0] avalon_st_adapter_012_out_0_error;                                         // avalon_st_adapter_012:out_0_error -> sys_timer_s1_agent:rdata_fifo_sink_error
	...
	nios_128k_base_mm_interconnect_0_router_003 router_003 (
	...
	nios_128k_base_mm_interconnect_0_router_003 router_004 (
	...
	nios_128k_base_mm_interconnect_0_router_002 router_005 (
	...
	nios_128k_base_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_base_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_base_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_base_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_128k_base_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
